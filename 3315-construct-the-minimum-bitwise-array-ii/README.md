...
<ul>
<li>Consider the binary representation of <code>nums[i]</code>.</li>
<li>Answer is -1 for even <code>nums[i]</code>.</li>
<li>Try unsetting a single bit from <code>nums[i]</code>.</li>
</ul>