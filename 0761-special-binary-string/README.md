...
<ul>
<li>Draw a line from (x, y) to (x+1, y+1) if we see a "1", else to (x+1, y-1).
...
However, you'll also need to deal with the case that S is a mountain, such as 11011000 -> 11100100.</li>
</ul>