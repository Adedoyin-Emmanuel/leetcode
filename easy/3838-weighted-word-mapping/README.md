...
<ul>
<li>For each word, sum character weights using <code>weights[c - 'a']</code></li>
<li>Take the sum modulo <code>26</code></li>
<li>Map the value to a character using reverse order: <code>char = 'z' - value</code></li>
