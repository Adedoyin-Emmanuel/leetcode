...
<ul>
<li>Think about how the final string will look like.</li>
<li>It will either start with a '0' and be like '010101010..' or with a '1' and be like '10101010..'</li>
<li>Try both ways, and check for each way, the number of changes needed to reach it from the given string. The answer is the minimum of both ways.</li>
</ul>