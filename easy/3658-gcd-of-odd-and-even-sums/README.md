...
<ul>
<li>The first <code>n</code> odd numbers sum to <code>n * n</code></li>
<li>First <code>n</code> even numbers sum to <code>n * (n + 1)</code></li>
<li><code>gcd(n, n + 1) = 1</code>, so the answer is <code>n</code></li>
</ul>