...
<ul>
<li>Find the minimum absolute difference between two elements in the array.</li>
<li>The minimum absolute difference must be a difference between two consecutive elements in the sorted array.</li>
</ul>