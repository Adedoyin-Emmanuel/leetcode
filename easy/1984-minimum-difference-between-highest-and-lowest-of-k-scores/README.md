...
<ul>
<li>For the difference between the highest and lowest element to be minimized, the k chosen scores need to be as close to each other as possible.</li>
<li>What if the array was sorted?</li>
<li>After sorting the scores, any contiguous k scores are as close to each other as possible.</li>
<li>Apply a sliding window solution to iterate over each contiguous k scores, and find the minimum of the differences of all windows.</li>
</ul>