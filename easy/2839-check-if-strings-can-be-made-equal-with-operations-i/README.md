...
<ul>
<li><div class="_1l1MA">Since the strings are very small you can try a brute-force approach.</div></li>
<li><div class="_1l1MA">There are only <code>2</code> different swaps that are possible in a string.</div></li>
</ul>