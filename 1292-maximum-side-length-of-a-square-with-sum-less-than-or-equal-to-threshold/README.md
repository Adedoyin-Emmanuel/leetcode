...
<ul>
<li>Store prefix sum of all grids in another 2D array.</li>
<li>Try all possible solutions and if you cannot find one return 0.</li>
<li>If x is a valid answer then any y < x is also valid answer. Use binary search to find answer.</li>
</ul>