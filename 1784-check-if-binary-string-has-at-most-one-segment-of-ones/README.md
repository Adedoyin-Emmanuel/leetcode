...
<ul>
<li>It's guaranteed to have at least one segment</li>
<li>The string size is small so you can count all segments of ones with no that have no adjacent ones.</li>
</ul>