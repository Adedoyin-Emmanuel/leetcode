...
<ul>
<li>Sort the <code>edges</code> array in descending order of weights.</li>
<li>Try using binary search on <code>ans</code>.</li>
<li>Implement a <code>chk</code> function which first adds all the edges with <code>must = 1</code>, and then adds the edges with <code>must = 0</code>, using any remaining upgrades greedily.</li>
<li>Use a <code>DSU</code> with path compression and union by size/rank to maintain connected components.</li>
<li>Don't forget the case where you cannot form an MST because more than one component remains after processing all edges.</li>
</ul>