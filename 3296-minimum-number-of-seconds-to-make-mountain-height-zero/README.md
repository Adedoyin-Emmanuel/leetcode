...
<ul>
<li>Can we use binary search to solve this problem?</li>
<li>Do a binary search on the number of seconds to check if it's enough to reduce the mountain height to 0 or less with all workers working simultaneously.</li>
</ul>