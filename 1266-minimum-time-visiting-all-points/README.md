...
<ul>
<li>To walk from point A to point B there will be an optimal strategy to walk ?</li>
<li>Advance in diagonal as possible then after that go in straight line.</li>
<li>Repeat the process until visiting all the points.</li>
</ul>