...
<ul>
<li>For each column, find the number of consecutive ones ending at each position.</li>
<li>For each row, sort the cumulative ones in non-increasing order and "fit" the largest submatrix.</li>
</ul>