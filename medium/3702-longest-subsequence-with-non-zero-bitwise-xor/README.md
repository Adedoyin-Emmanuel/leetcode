...
<ul>
<li>What happens if you take the entire array?</li>
<li>If the XOR of the entire array is 0, can removing one element help?</li>
<li>What if all elements are 0?</li>
</ul>