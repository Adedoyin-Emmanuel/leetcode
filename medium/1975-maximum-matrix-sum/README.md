...
<ul>
<li>Try to use the operation so that each row has only one negative number.</li>
<li>If you have only one negative element you cannot convert it to positive.</li>
</ul>