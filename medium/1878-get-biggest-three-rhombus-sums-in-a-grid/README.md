...
<ul>
<li>You need to maintain only the biggest 3 distinct sums</li>
<li>The limits are small enough for you to iterate over all rhombus sizes then iterate over all possible borders to get the sums</li>
</ul>