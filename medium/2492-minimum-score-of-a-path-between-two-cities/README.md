...
<ul>
<li>Can you solve the problem if the whole graph is connected?</li>
<li>Notice that if the graph is connected, you can always use any edge of the graph in your path.</li>
<li>How to solve the general problem in a similar way? Remove all the nodes that are not connected to 1 and n, then apply the previous solution in the new graph.</li>
</ul>