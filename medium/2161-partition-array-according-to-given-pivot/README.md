...
<ul>
<li>Could you put the elements smaller than the pivot and greater than the pivot in a separate list as in the sequence that they occur?</li>
<li>With the separate lists generated, could you then generate the result?</li>
</ul>