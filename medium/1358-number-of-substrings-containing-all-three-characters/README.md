...
<ul>
<li>For each position we simply need to find the first occurrence of a/b/c on or after this position.</li>
<li>So we can pre-compute three link-list of indices of each a, b, and c.</li>
</ul>