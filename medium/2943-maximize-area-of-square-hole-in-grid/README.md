...
<ul>
<li>Sort <code>hBars</code> and <code>vBars</code> and consider them separately.</li>
<li>Compute the longest sequence of consecutive integer values in each array, denoted as <code>[hx, hy]</code> and <code>[vx, vy]</code>, respectively.</li>
<li>The maximum square length we can get is <code>min(hy - hx + 2, vy - vx + 2)</code>.</li>
<li>Square the maximum square length to get the area.</li>
</ul>