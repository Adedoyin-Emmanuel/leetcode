...
<ul>
<li>Consider a palindrome as composed of two mirror-image halves.</li>
<li>Construct one half (using <code>s</code>), and then the other half is its reverse to obtain the lexicographically smallest permutation.</li>
</ul>