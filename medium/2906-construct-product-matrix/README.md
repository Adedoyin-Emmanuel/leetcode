...
<ul>
<li>Try to solve this without using the <code>'/'</code> (division operation).</li>
<li>Create two 2D arrays for <b>suffix</b> and <b>prefix</b> product, and use them to find the product for each position.</li>
</ul>