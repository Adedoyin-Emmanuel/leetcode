...
<ul>
<li>Put all the possible prefixes of each element in <code>arr1</code> into a HashSet.</li>
<li>For all the possible prefixes of each element in <code>arr2</code>, check if it exists in the HashSet.</li>
</ul>