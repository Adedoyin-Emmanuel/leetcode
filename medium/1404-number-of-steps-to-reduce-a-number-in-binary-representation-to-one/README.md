...
<ul>
<li>Read the string from right to left, if the string ends in '0' then the number is even otherwise it is odd.</li>
<li>Simulate the steps described in the binary string.</li>
</ul>