...
<ul>
<li>Start DFS from the node (0, 0) and follow the path till you stop.</li>
<li>When you reach a cell and cannot move anymore check that this cell is (m - 1, n - 1) or not.</li>
</ul>