...
<ul>
<li>There are limited outcomes given the current sum and the stones remaining.</li>
<li>Can we greedily simulate starting with taking a stone with remainder 1 or 2 divided by 3?</li>
</ul>