...
<ul>
<li>We have 8 keys in total. We can type 8 characters with one push each, 8 different characters with two pushes each, and so on.</li>
<li>The optimal way is to map letters to keys evenly.</li>
<li>Sort the letters by frequencies in the word in non-increasing order.</li>
</ul>