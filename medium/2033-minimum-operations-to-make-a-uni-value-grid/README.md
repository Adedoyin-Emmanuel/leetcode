...
<ul>
<li>Is it possible to make two integers a and b equal if they have different remainders dividing by x?</li>
<li>If it is possible, which number should you select to minimize the number of operations?</li>
<li>What if the elements are sorted?</li>
</ul>