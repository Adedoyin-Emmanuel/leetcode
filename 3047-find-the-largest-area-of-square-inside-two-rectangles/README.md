...
<ul>
<li>Brute Force the intersection area of each pair of rectangles.</li>
<li>Two rectangles will not overlap when the bottom left x coordinate of one rectangle is greater than the top right x coordinate of the other rectangle. The same is true for the y coordinate.</li>
<li>The intersection area (if any) is also a rectangle. Find its corners.</li>
</ul>