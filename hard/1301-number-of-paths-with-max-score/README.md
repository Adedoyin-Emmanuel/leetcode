...
<ul>
<li>Use dynamic programming to find the path with the max score.</li>
<li>Use another dynamic programming array to count the number of paths with max score.</li>
</ul>