...
<ul>
<li><code>t</code> should only have 2, 3, 5 and 7 as prime factors.</li>
<li>Find the shortest suffix that must be changed.</li>
<li>Try to form the string greedily.</li>
</ul>