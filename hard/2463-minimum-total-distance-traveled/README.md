...
<ul>
<li>Sort robots and factories by their positions.</li>
<li>After sorting, notice that each factory should repair some subsegment of robots.</li>
<li>Find the minimum total distance to repair first i robots with first j factories.</li>
</ul>