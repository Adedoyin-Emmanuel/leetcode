// Last updated: 1/13/2026, 5:11:46 AM
// Let's gooo
...
39     let minTime = 0;
40
41     while(i < points.length - 1){
42
43        const x1 = points[i][0], x2 = points[i + 1][0];
44        const y1 = points[i][1], y2 = points[i + 1][1];
45
46        const dx = Math.abs(x2 - x1), dy = Math.abs(y2 - y1);
47
48        minTime += Math.max(dx, dy);
49
50        i ++;
51     }
52
